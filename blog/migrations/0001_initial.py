# Generated by Django 3.2.5 on 2021-07-30 11:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header_image', models.ImageField(blank=True, null=True, upload_to='post/images/')),
                ('body', ckeditor.fields.RichTextField(blank=True, null=True)),
                ('post_date', models.DateField(auto_now_add=True, null=True)),
                ('category', models.CharField(default='Umbanda', max_length=255)),
